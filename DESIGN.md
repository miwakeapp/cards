...
TODO: the given setup doesn't seem to work well if we want slightly more hints on the front, e.g., the part of speech. Ist hat an issue?
...
The default [leech settings](https://docs.ankiweb.net/leeches.html#leeches) for the deck this software creates will be left at the Anki default of suspending after 8. But this software can provide better tooling for what happens to the leeches afterward.
...
A core part of this project is the dictionary entries displayed on the back of each card. Unlike Jitendex, we want these to be created using semantic HTML that can easily be styled, with redundant parts hidden, etc.

Popular JMDict displays we can compare to include [Takoboto](https://takoboto.jp/) (my favorite), [Jisho.org](https://jisho.org/) (anecdotally popular), [WWWJDIC](https://www.edrdg.org/cgi-bin/wwwjdic/wwwjdic) (the official JMDict frontend), [Tangorin](https://tangorin.com/), and [Lorenzi's Jisho](https://jisho.hlorenzi.com/).
...
<ul class="forms">
  ...
  <li class="tag-rK common-false"><span lang="ja">劃期的</span><ul class="tags"><li>rarely-used</li></ul></li>
</ul>
```
...
<p id="context-sentence">{{furigana:Minimized context sentence}}{{^Minimized context sentence}}{{furigana:Full context sentence}}{{/Minimized context sentence}}</p>
